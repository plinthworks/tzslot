 ...
 *
 * One bundle provided once, rather than a string input on each component:
 * translating an application should not mean passing fifteen attributes at
 ...
 * `locale` input, which already knows them in every language the browser ships.
